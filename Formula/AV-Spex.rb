class AvSpex < Formula
  ...
  url "https://github.com/JPC-AV/video_qc_jpc_av/archive/refs/tags/v0.8.2.tar.gz"
  sha256 "7816cc049b6efd88fee62e7f05a6d61f517f8c4622684a13fd21f2e5ec14dee4"
  license "GPL-3.0-only"

  bottle do
    root_url "https://github.com/JPC-AV/video_qc_jpc_av/releases/download/v0.8.2"
    sha256 cellar: :any_skip_relocation, arm64_sonoma: "46762138dbf87abf7a24002db2b61f4898ca7a98ac4e12a88f87346dd18af6f4"
    sha256 cellar: :any_skip_relocation, ventura: "bef37bf60fe37d78a0d2ff49c8fd400550f80dbe3a90cccda4f29dbd53c2dccb"
  end
