class AvSpex < Formula
  ...
  url "https://github.com/JPC-AV/video_qc_jpc_av/archive/refs/tags/v0.7.9.tar.gz"
  sha256 "9aa56c09d619323f5b305d31bcc0ec001ae7189239cb917121b0de8f8628e45f"
  license "GPL-3.0-only"

  bottle do
    root_url "https://github.com/JPC-AV/video_qc_jpc_av/releases/download/v0.7.9"
  end
