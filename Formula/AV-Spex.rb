...
class AvSpex < Formula
  ...
  url "https://github.com/JPC-AV/JPC_AV_videoQC/archive/refs/tags/v0.7.1.tar.gz"
  sha256 "1984677f24a4cf36a5769c4352e8dbb3ea61034e45556447fa9f52d1f9011f95"
  license "GPL-3.0-only"

  bottle do
    root_url "https://github.com/JPC-AV/JPC_AV_videoQC/releases/download/v0.7.1"
    sha256 cellar: :any_skip_relocation, 
    arm64_sonoma: "3037da13af06a5db2144da41491716cfc487b86da45a7a723faf16311e05e0e5"
  end
